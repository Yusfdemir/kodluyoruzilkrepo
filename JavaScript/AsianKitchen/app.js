...
var createButoon= () =>{
  let buttons= `
  <button id="all" class="btn-item btn btn-outline-dark ">All</button>
  <button id="korea" class="btn-item btn btn-outline-dark">Korea</button>
  <button id="japan" class="btn-item btn btn-outline-dark">Japan</button>
  <button id="china" class="btn-item btn btn-outline-dark">China</button>
  `
  butonlar.innerHTML=buttons;
}
createButoon();
...
const listKoreaFoods = () => {
  ...
  menuItems.innerHTML = koreaFoods;
}
...
const listJapanFoods = () => {
  ...
  menuItems.innerHTML = japanFoods;
}
...
const listChinaFoods = () => {
  ...
  menuItems.innerHTML = chinaFoods;
}
